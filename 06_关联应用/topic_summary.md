...
| 004 | `004_计算平均支付间隔.md` | 计算平均支付间隔 | 订单支付日志关联、时间戳差、平均间隔 | 否 | 是 |
| 005 | `005_网易云音乐推荐.md` | 网易云音乐推荐 | 关注链路、多表关联、反连接去重推荐 | 否 | 是 |
| 006 | `006_产品年度销售额与竞品对比.md` | 产品年度销售额与竞品对比 | 季度销售汇总、多表关联、竞品差额 | 否 | 是 |
